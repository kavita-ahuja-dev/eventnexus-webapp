...
//     [
//       "title","description","date","venue","price","year","mode","zoomUrl",
...
//     // active: coerce to boolean and compare
...
//       navigate("/admin/manage-events"); // or back to list
//     } catch (e) {
...
//           <input type="checkbox" className="form-check-input me-2" id="active" name="active" checked={!!form.active} onChange={onChange} />
...
//           <input className="form-control" name="typeId" value={form.typeId ?? ""} onChange={onChange} />
//         </div>
//         <div className="col-md-4">
...
//           />
//           <div className="form-text">Keep = leave unchanged, Remove = delete image.</div>
//         </div>
//         <div className="col-md-4 d-flex gap-2 align-items-end">
//           <button type="button" className={`btn ${form.keepImage ? "btn-secondary" : "btn-outline-secondary"}`} onClick={setKeepImage}>
//             Keep
//           </button>
//           <button type="button" className={`btn ${form.removeImage ? "btn-danger" : "btn-outline-danger"}`} onClick={setRemoveImage}>
//             Remove
//           </button>
//         </div>
